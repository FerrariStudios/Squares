...
public class Draw {
    ...
    public static void drawTriangle(Point a, Point b, Point c, Paint p, Canvas canvas) {
        int width = canvas.getWidth();
        int height = canvas.getHeight();

        drawTriangle(a.getX(), a.getY(), b.getX(), b.getY(), c.getX(), c.getY(), p, canvas);
    }
    ...
    public static RectF createRectF(float left, float top, float right, float bottom, Canvas c) {
        float width = (int) (0.01 * c.getWidth());
        float height = (int) (0.01 * c.getHeight());
